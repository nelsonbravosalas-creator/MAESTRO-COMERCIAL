...
export type QuotationKind = 'project' | 'maintenance'
export type MtcFrequency = 'mensual' | 'trimestral' | 'semestral' | 'anual'
...
export interface MasterQuotation {
  ...
  updated_at: string
  // Mantención (kind='maintenance'): contratos de servicio recurrente,
  // aparte de las cotizaciones de proyecto puntual ('project', default).
  kind: QuotationKind
  equipment_count: number | null
  equipment_description: string | null
  frequency: MtcFrequency | null
